<div class="wrap">
<div class="icon32" style="width:40px; vertical-align:middle;"><img src="../wp-content/plugins/linkedin-master/techgasp-minilogo.png" alt="' . esc_attr__( 'TechGasp Plugins') . '" /><br /></div>

<h2><b>TechGasp - LinkedIn Master LITE Version</b></h2>
<form method="post" action="techgasp-linkedinmaster-admin.php"> 
...
<img src="../wp-content/plugins/linkedin-master/techgasp-linkedinmaster-logo.png" alt="LinkedIn Master" align="left" width="387px" height="171px" style="padding:5px;"/>
<p><h2>LinkedIn Master:</h2></p>
<p>LinkedIn Master, if you are serious about your linkedin connections and want to integrate your personal or company linkedin page into your wordpress.</p>
</br>
<p><em>Business class LinkedIn company or personal profile for wordpress...</em><p>
</br>
</br>
<p><h3>Options & Configuration:</h3></p>
<p><b>All configuration options are available in your widgets page. LinkedIn Master Widget:</b></p>
<p>Select or <em>"add"</em > LinkedIn Master Widget. Configure your settings. Select widget position according to your template. That easy...</p>
<p><b>Insert LinkedIn Master Widget inside Pages and Posts (advanced version only):</b></p>
<p>Copy and Paste this shortcode inside your pages or posts [linkedinmaster id=xx] replace xx with your sidebar number, ie [linkedinmaster id=sidebar-1]</p>
<p><a class="button-primary" href="widgets.php" title="Widgets Page">To Widgets Page</a> <a class="button-secondary" href="http://wordpress.techgasp.com/linkedin-master/" target="_blank" title="More Help">More Help</a> <a class="button-primary" href="http://wordpress.techgasp.com/linkedin-master/" target="_blank" title="LinkedIn Master Advanced Version">LinkedIn Master Advanced Version</a></p>
<hr>
<p><h3>LinkedIn Master Advanced Version</h3></p>
<p>Lite version contains LinkedIn Share Website Button.</p>
<p>Advanced version contains LinkedIn Share Website Button plus LinkedIn Company Profile View and LinkedIn Personal Profile View</p>
